...
docker exec clab-lab1-part1-host1 chmod o=rw /lab-folder/h1.pcap

docker exec clab-lab1-part1-host2 touch /lab-folder/h2.pcap
docker exec clab-lab1-part1-host2 chmod o=rw /lab-folder/h2.pcap

docker exec clab-lab1-part1-host3 touch /lab-folder/h3.pcap
docker exec clab-lab1-part1-host3 chmod o=rw /lab-folder/h3.pcap

docker exec clab-lab1-part1-host4 touch /lab-folder/h4.pcap
docker exec clab-lab1-part1-host4 chmod o=rw /lab-folder/h4.pcap
